...
const CreatePost = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (form.prompt && form.photo) {
      setLoading(true);
      try {
        const response = await fetch("http://localhost:9090/api/v1/post", {
          method: "POST",
          headers: {
      ...
      alert('Please enter a valid prompt and generate a image');
    }
  };
  ...
  return (
    <section className="max-w-7xl mx-auto">
      <div>
        ...
        <p className="mt-2 text-[#666e75] text-[16px] max-w[50px] ">
